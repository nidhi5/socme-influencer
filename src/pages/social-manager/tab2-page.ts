...
@Component({
  ...
  <ion-item>
    <ion-avatar item-start>
      <ion-icon name="logo-apple" color="apple"></ion-icon>
      <ion-badge item-end color="apple">1732k</ion-badge>
    </ion-avatar>
    <h2 class="ionic">Bob Merley</h2>
    <p color="dark">Ionic apps are created and developed primarily through the Ionic command line utility (the “CLI”), and use Cordova to build and deploy as a native app. This means we need to install a few utilities to get developing.</p>
  </ion-item>
